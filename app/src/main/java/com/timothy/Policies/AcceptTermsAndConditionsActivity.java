...
public class AcceptTermsAndConditionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accept_terms_and_conditions);

        Window w = AcceptTermsAndConditionsActivity.this.getWindow();
                    ...
                    YoYo.with(Techniques.FadeIn).duration(200).onStart(new YoYo.AnimatorCallback() {
                        ...
                        public void call(Animator animator) {
                            YoYo.with(Techniques.RubberBand).duration(400).onEnd(new YoYo.AnimatorCallback() {
                                @Override
                                public void call(Animator animator) {
                                    Intent intent = new Intent(AcceptTermsAndConditionsActivity.this, WelcomeActivity.class);
